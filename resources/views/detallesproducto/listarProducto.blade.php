...
<div class="container" >
    ...
    <table id="idproductos" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                <td style="text-align:justify;">{{$detallesproducto->id}}</td>
                <td style="text-align:justify;">{{$detallesproducto->name}}</td>
                <td style="text-align:justify;">{{$detallesproducto->descripcion}}</td>
     ...
     {{--                <img src="{{ asset('storage').'/'.$producto->imagen}}" alt="" width="200"> --}}
                  {{--   <img src="/img/Multimedia/{{$producto->imagen}}" alt="{{$producto->imagen}}" width="500px"> --}}
                    <img src="{{asset($detallesproducto->imagen)}}" alt="" width="100px">
                </td>

                


                <td style="text-align:justify;">{{$detallesproducto->talla}}</td>
                <td style="text-align:justify;">{{$detallesproducto->marca}}</td>
                <td style="text-align:justify;">{{$detallesproducto->color}}</td> 
                <td style="text-align:justify;">{{$detallesproducto->cantidad}}</td> 
                <td style="text-align:justify;">{{$detallesproducto->precio}}</td> 
